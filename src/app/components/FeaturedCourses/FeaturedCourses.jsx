...
const courses = [
  {
    ...
    reviews: 1,
    price: 82,
    tag: 'Map Animation Documentary Style',
  ...
  {
    id: 6,
    title: 'Freelance Graphic Design with Canva',
    lessons: 11,
    duration: '9h 30m',
    students: 35,
    rating: 4,
...
const filterOptions = ['All', 'Map Animation Documentary Style', 'Reels Editing', 'YouTube Automation', 'Freelancing', 'Free'];
